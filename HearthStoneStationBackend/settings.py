"""
Django settings for HearthStoneStationBackend project.
...
SECRET_KEY = '97y$&h-pe69&ujp8f(kaeuvz(gtx*c-)+0htiw3yr4#12qrev6'
...
WSGI_APPLICATION = 'HearthStoneStationBackend.wsgi.application'
