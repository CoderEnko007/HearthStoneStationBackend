...
class Decks(models.Model):
    ...
    card_array = models.TextField(default='', null=True, blank=True, verbose_name='包含的单卡id')
    set_array = models.TextField(default='', null=True, blank=True, verbose_name='包含的扩展包')
